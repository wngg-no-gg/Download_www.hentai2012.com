...
def main():
    ...
    file = open('result_doujin.txt', 'a')

    number = 0

    #for page in range(1,3):
    for page in range(1, 2014 + 1):

        print("Page:" + str(page))

        # get web
        url = ROOT_OF_WEB + "/hentai_doujin/page_" + str(page) + ".html"
        ...
        for i in range(0,len(BooksOfThePage)) :
            ...
            file.write("CODIFICATION:" + re.search('<a href="/hentai_doujin/(\d*)/" class="thumbnail">',BooksOfThePage[i]).group(1) + "\n")
